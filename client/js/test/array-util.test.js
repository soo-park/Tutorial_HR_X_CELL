// receiving a variable passed from array-util file above
// in array util, there is module.export = {getRange:getRange} 
// when new test added, don't forget to receive var
const { getRange,
        getLetterRange } = require('../array-util');

// Describe is a function in the Jasmine/Jest testing framework. 
